...
tabbarMenu = function(){
	...
	html+='<ons-tabbar position="bottom" animation="none" modifier="is_rtl" >';
	    ...
	    html+='</ons-tab>';	    
	    html+='<ons-tab id="tab-profile" page="profile.html" label="'+ t("Account") +'" icon="user-alt" active-icon="user-alt" >';
	    html+='</ons-tab>';	   
		html+='<ons-tab id="tab-history" page="order_list.html" label="'+ t("History") +'" icon="shopping-cart" active-icon="shopping-cart" badge="" >';
	    html+='</ons-tab>';
